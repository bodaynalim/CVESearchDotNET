...
namespace Cve.Net.Search.Infrastructure.Attributes.Jobs
{
    /// <summary>
    ...
    public class MutexAttribute : JobFilterAttribute, IElectStateFilter, IApplyStateFilter
    {
        ...
        public MutexAttribute(string resource, int retryInSeconds = 15, int maxAttempts = 0)
        {
            _resource = resource;
        ...
        public void OnStateElection(ElectStateContext context)
        {
            ...
            context.CandidateState = MaxAttempts == 0 || currentAttempt > 0 && currentAttempt <= MaxAttempts
