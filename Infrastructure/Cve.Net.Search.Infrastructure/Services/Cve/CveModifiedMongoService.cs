...
public class CveModifiedMongoService : BaseMongoService<CveModifiedMongoModel>, ICveModifiedMongoService
{
    ...
    public override async Task<CveModifiedMongoModel> CreateOrUpdateExisting(CveModifiedMongoModel item, CancellationToken cancellationToken = default)
    {
    ...
    public override async Task<CveModifiedMongoModel> CreateNewItemIfNotExist(CveModifiedMongoModel item, CancellationToken cancellationToken = default)
    {
        var any = await Collection.Find(s => s.CveId == item.CveId).FirstOrDefaultAsync(cancellationToken);
    ...
    public override async Task<CveModifiedMongoModel> Get(string id, CancellationToken cancellationToken = default)
    {
        return await Collection.Find(s => s.CveId == id).FirstOrDefaultAsync(cancellationToken);
    }

    public async Task LogChanges(CveMongoModel old, CveMongoModel newItem, CancellationToken cancellationToken = default)
    {
